...
- Dagre 2.0.0 (`dagre-2.0.0.min.js`), MIT license.
...
Dagre computes the compact directed-acyclic-graph layout; SVG rendering and
interaction remain part of Simjecture.
